...
echo "Downloading and unzipping the AGN Galaxy Zoo 1 AGN host galaxies sample ..."
wget --quiet --show-progress https://galaxy-zoo-1.s3.amazonaws.com/schawinski_GZ_2010_catalogue.fits.gz?download=1 -O schawinski_GZ_2010_catalogue.fits.gz
gunzip schawinski_GZ_2010_catalogue.fits.gz
